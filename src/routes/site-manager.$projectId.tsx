    ...
    <div className="relative min-h-[calc(100vh-4rem)] overflow-hidden bg-background">
      ...
      {activePin && (
        <div className="fixed bottom-6 right-6 z-40 w-80 rounded-lg border-2 border-alert bg-black/90 p-4 shadow-2xl backdrop-blur">
          ...
          <button
            ...
            className="mt-3 w-full rounded-md bg-alert px-3 py-2 text-[0.65rem] font-extrabold uppercase tracking-widest text-alert-foreground shadow hover:bg-alert/90"
          >
      ...
      {forcePin && (
        <ForceCheckoutModal
          pinId={forcePin.id}
          projectId={projectId}
          tradeLabel={forcePin.trade_package}
          onClose={() => {
            setForcePin(null);
            setActivePin(null);
          }}
