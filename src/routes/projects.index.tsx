...
function ProjectsPage() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] overflow-hidden bg-background">
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-14 pb-32 sm:px-6">
        <div className="grid grid-cols-[minmax(0,1fr)_auto] items-end gap-3 sm:flex sm:justify-between sm:gap-4">
          <div className="min-w-0">
            <p className="text-[0.7rem] font-bold uppercase tracking-[0.4em] text-alert">
              Portfolio
            </p>
            <h1
              className="mt-2 text-3xl font-extrabold uppercase tracking-tight text-foreground sm:text-4xl md:text-5xl"
          ...
          {canCreate && (
            <Link
              ...
              className="btn-primary inline-flex shrink-0 items-center gap-2 rounded-xl px-3 py-2.5 text-xs uppercase tracking-wider sm:px-5 sm:py-3 sm:text-sm"
            >
              <Plus size={16} className="shrink-0" />
              <span className="whitespace-nowrap">New</span>
              <span className="hidden whitespace-nowrap sm:inline">Project</span>
            </Link>
          )}
        </div>
